...
class User(Base):
    ...
    # The Base32 TOTP secret generated by pyotp. Null until the user enrolls.
    totp_secret = Column(String, nullable=True)
    # Flag flipped to True only after the user scans the QR code and confirms a valid code.
    is_2fa_enabled = Column(Boolean, default=False, server_default='0', nullable=False)
